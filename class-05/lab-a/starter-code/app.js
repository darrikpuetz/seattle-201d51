...
function sumArray(testArray) { //eslint-disable-line
  var sumQuestionFour = sum(testArray[0], testArray[1], testArray[2]);
  return[sumQuestionFour[0], testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + sumQuestionFour[0] + ' is their sum.'];
}
